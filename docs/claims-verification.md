...
| 36 | METABIOMED end-card at the close of the supplied product film | `public/video/renuvol-intro.mp4` (~41.8s onward) | **LEGAL-REVIEW** | Rights to display the manufacturer's mark on RENUVOL/LA BEAUTEX marketing, plus a decision on whether to surface the manufacturer relationship publicly at all | Not currently | The hero stops at 39.4s (`data-rv-end`), before the end-card. Revisit if the film is replaced |
