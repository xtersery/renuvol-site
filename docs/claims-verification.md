...
| 34 | Product packaging label reads "PREMIUM COMETOLOGY" on some renders vs. "PREMIUM PDO BOOSTER" on Instagram assets and the film | `public/images/product/*` vs. `public/references/instagram/04-product-visuals/*` vs. `public/video/renuvol-intro.mp4` | **UNVERIFIED** — inconsistency, not a claim per se | Confirm which label text is the approved final packaging copy; "COMETOLOGY" (and "COME TOLOGY") appear to be generation artefacts | N/A (asset-consistency issue) | Resolved for now by using only the film still, whose label is clean; the renders are DO-NOT-USE (`docs/asset-audit.md`) |
| 35 | Composition figures printed on the carton render: "100mg / Vial", "PDO 35mg, PN 8mg" | `public/images/product/image-Photoroom.png` (an AI-generated render) | **UNVERIFIED** | Confirmation from real packaging artwork or manufacturer documentation. `content/placeholders.md` explicitly lists dosage as unavailable, and these figures come from an asset of unconfirmed provenance | No — not in copy, and not via imagery either | Omit. The site shows no dose, concentration or composition figure anywhere |
| 36 | METABIOMED end-card at the close of the supplied product film | `public/video/renuvol-intro.mp4` (~41.8s onward) | **LEGAL-REVIEW** | Rights to display the manufacturer's mark on RENUVOL/LA BEAUTEX marketing, plus a decision on whether to surface the manufacturer relationship publicly at all | Not currently | The film modal stops at 39.4s (`data-rv-end` on the `<video>` in `src/sections/14-video-modal.html`), before the end-card. Retime it if the film is replaced |
| 37 | Hydration imaging study figures: "+35,2% в среднем", "индивидуальные улучшения до 102,80%", "после 2 недель применения", plus eight before/after imaging tiles | Manufacturer study slide supplied directly by the site owner in RU and EN versions (`public/images/proof/hydration-*.webp`) | **VERIFIED** (tier 3, owner-supplied) — published at the owner's explicit instruction | The study document behind the slide is not filed in this repo: sample size, methodology and measurement device are unknown here. File it so the figures can be defended if a specialist asks | Yes — as the supplied slide, unaltered | The numbers are published only inside the slide image, never re-stated as site copy. Do not paraphrase, round, or lift them into a headline: the claim stands or falls with the document it came from |
| 38 | Skin plumping study figures: "клинически доказанный эффект наполнения кожи", "улучшение объёма кожи до 21,73%", "после 2 недель", plus eight before/after imaging tiles | Manufacturer study slide supplied directly by the site owner in RU and EN versions (`public/images/proof/plumping-*.webp`) | **VERIFIED** (tier 3, owner-supplied) — published at the owner's explicit instruction | Same gap as row 37: the study behind the slide is not filed here, so sample size, methodology and measurement device are unknown. "Клинически доказанный" is a stronger wording than row 37 carries and needs the study on file before it is defended in front of a specialist | Yes — as the supplied slide, unaltered | Published only inside the slide image, never re-stated as site copy. The slide is attached to chapter 03 "Эластичность" though it describes volume/plumping — closer to chapter 02 "Плотность"; placement is the owner's decision |
| 39 | Section 08 copy: "Нобелевская технология для вашей практики"; "INCUBE™ помогает защищать активные компоненты формулы, обеспечивая их стабильность и точность работы"; "all-in-one PDO booster"; "Официальный дистрибьютор RENUVOL в России" | Copy supplied directly by the site owner | **UNVERIFIED** — published at the owner's instruction, sources not filed | Three separate things. (a) The 2025 Nobel Prize in Chemistry was awarded for metal-organic frameworks — to the chemists who developed them, not to INCUBE™ or RENUVOL. "Нобелевская технология" borrows that authority for the product and needs a form of words the distributor can defend, plus the underlying licence or documentation showing INCUBE actually uses MOF chemistry. (b) The stabilisation claim needs the study or manufacturer specification behind it. (c) The distributor status needs the contract or letter of authorisation. | Yes, as supplied | The copy is already hedged ("помогает защищать", no numbers, no claim that the prize was awarded to the product). Do not strengthen it — "защищает", "доказано" or a named laureate would turn a positioning line into an assertion of fact. The distributor claim is the one to document first: it is checkable and specific |
| 40 | Section 08 dialog (21-incube-story.html): "Нобелевскую премию по химии 2025 присудили за развитие MOF"; "MOF создают вокруг активов молекулярный каркас"; "INCUBE™ защищает витамин C и глутатион"; "До 100% антиоксидантной активности — внутри готового препарата"; "LabIncube одной из первых коммерциализировала MOF-технологию" | Copy supplied directly by the site owner | **UNVERIFIED** — published at the owner's instruction | The Nobel statement itself is a matter of public record and checkable. The rest is not, and two items carry the most weight: "до 100% антиоксидантной активности" is a measured figure and needs the assay behind it — method, timepoint and what it is 100% of; "одной из первых коммерциализировала" is a priority claim about a company and needs a source that does not originate with the company. The link from MOF chemistry to what INCUBE actually does inside RENUVOL needs the manufacturer's specification | Yes, as supplied | Published as body copy inside a dialog the visitor opens deliberately, not as a headline. Do not lift the 100% figure into the section itself or into a heading: as a standalone claim on the page it reads as a product guarantee. Row 39 covers the shorter wording used in the section |
